({
    ...
    signatureClear : function(component, event, helper){
        ...
        if(component.get("v.contentDocumentID") != null){
        var action = component.get("c.deleteSavedImg");
        action.setParams({
            contentID 		 : component.get("v.contentDocumentID")
        });
    ...
    signatureSave :function(component, event, helper){
        ...
        action.setCallback(this,function(response){
            ...
            if(state==="SUCCESS"){
                component.set("v.contentDocumentID", response.getReturnValue().ContentDocumentId);
                component.set("v.Filename", response.getReturnValue().fileTitle);
